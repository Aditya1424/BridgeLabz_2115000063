...
public class UniversityCourseManagementSystem{
  public static void main(String[] args) {
    ExamCourse math101 = new ExamCourse("Math 101", "Aditya", 100);
    ExamCourse physics101 = new ExamCourse("Physics 101", "Abhay", 150);

    AssignmentCourse compSci101 = new AssignmentCourse("Computer Science 101", "Dhruv", 5);
    AssignmentCourse econ101 = new AssignmentCourse("Economics 101", "Divyansh", 7);

    ResearchCourse aiResearch =
        new ResearchCourse("AI Research", "Ayan", "Artificial Intelligence");
    ResearchCourse biotechResearch =
        new ResearchCourse("Biotech Research", "Utkarsh", "Genetics");
